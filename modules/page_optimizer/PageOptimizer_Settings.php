...
/**
 * Page Optimizer settings storage.
 */
class PageOptimizer_Settings
{
    ...
    /**
     * Prepare module storage during HostCMS module installation.
     */
    public static function install($siteId = null)
    {
        ...
        return is_file($file) || self::save(self::$defaults, $siteId);
    }

    /**
     * Remove generated settings and asset cache.
     */
